...
namespace GoBike.API.App.Controllers.Interactive
{
    ...
    public class DeleteRequestForAddFriendController : ApiController
    {
        ...
        public DeleteRequestForAddFriendController(ILogger<DeleteRequestForAddFriendController> logger, IMemberService memberService)
        {
            this.logger = logger;
        ...
        public async Task<IActionResult> Post(MemberBaseCommandDto memberBaseCommand)
        {
            ...
            try
            {
                ResponseResultDto responseResult = await this.memberService.DeleteRequestForAddFriend(new MemberInteractiveCommandDto() { InitiatorID = memberID, ReceiverID = memberBaseCommand.MemberID });
