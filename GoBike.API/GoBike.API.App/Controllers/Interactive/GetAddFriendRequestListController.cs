...
namespace GoBike.API.App.Controllers.Interactive
{
    ...
    public class GetAddFriendRequestListController : ApiController
    {
        ...
        public GetAddFriendRequestListController(ILogger<GetAddFriendRequestListController> logger, IMapper mapper, IMemberService memberService)
        {
            this.logger = logger;
            this.mapper = mapper;
        ...
        public async Task<IActionResult> Get()
        {
            ...
            try
            {
                ResponseResultDto responseResult = await this.memberService.GetAddFriendRequestList(new MemberInteractiveCommandDto() { InitiatorID = memberID });
