...
namespace GoBike.API.App.Controllers.Interactive
{
    ...
    public class GetFriendListController : ApiController
    {
        ...
        public GetFriendListController(ILogger<GetFriendListController> logger, IMapper mapper, IMemberService memberService)
        {
            this.logger = logger;
            this.mapper = mapper;
        ...
        public async Task<IActionResult> Get()
        {
            ...
            try
            {
                ResponseResultDto responseResult = await this.memberService.GetFriendList(new MemberInteractiveCommandDto() { InitiatorID = memberID });
