using AutoMapper;
using GoBike.Friend.Core.Resource;
...
namespace GoBike.Friend.Service.Managers
{
    /// <summary>
    /// 互動服務
    /// </summary>
    public class InteractiveService : IInteractiveService
    {
        ...
        public async Task<string> AddFriend(InteractiveInfoDto interactiveInfo)
        {
            try
            {
                ...
                bool isPassiveSuccess = await this.interactiveRepository.UpdateInteractiveData(passiveInteractiveData);
        ...
        public async Task<string> DeleteRequestForAddFriend(InteractiveInfoDto interactiveInfo)
        {
            try
            {
                ...
                {
                    return await this.GetInteractiveStatusMemo(interactiveInfo, false);
                }
        ...
        public async Task<string> RejectBeFriend(InteractiveInfoDto interactiveInfo)
        {
            try
            {
                ...
                {
                    return await this.GetInteractiveStatusMemo(interactiveInfo, true);
                }
        ...
        {
            return Tuple.Create<MemberInfoDto, string>(null, string.Empty);
        }
        ...
        ///// <returns>string</returns>
        //public async Task<string> AddBlacklist(InteractiveDto interactiveDto)
        //{
        //    try
        //    {
        //        if (string.IsNullOrEmpty(interactiveDto.InitiatorID) || string.IsNullOrEmpty(interactiveDto.PassiveID))
        //        {
        //            return "會員編號無效.";
        //        }

        //        FriendData friendData = await this.friendRepository.GetFriend(interactiveDto.InitiatorID, interactiveDto.PassiveID);
        //        if (friendData == null)
        //        {
        //            friendData = this.CreateFriendData(interactiveDto);
        //        }

        //        friendData.Status = (int)FriendStatusType.Black;
        //        bool isSuccess = await this.friendRepository.UpdateFriendData(friendData); //// TODO 測試更新會不會自動建檔
        //        if (!isSuccess)
        //        {
        //            return "加入黑名單失敗.";
        //        }
        ...
        //    catch (Exception ex)
        //    {
        //        this.logger.LogError($"Build Blacklist Error >>> InitiatorID:{interactiveDto.InitiatorID} PassiveID:{interactiveDto.PassiveID}\n{ex}");
        //        return "加入黑名單發生錯誤.";
        //    }
        //}
        ...
        ///// <param name="interactiveDto">interactiveDto</param>
        ///// <returns>string</returns>
        //public async Task<string> CancelBlacklist(InteractiveDto interactiveDto)
        //{
        //    try
        //    {
        //        if (string.IsNullOrEmpty(interactiveDto.InitiatorID) || string.IsNullOrEmpty(interactiveDto.PassiveID))
        ...
        //        if (friendData.Status != (int)FriendStatusType.Black)
        //        {
        //            return "未設定對方為黑名單.";
        //        }

        //        bool isSuccess = await this.friendRepository.DeleteFriendData(interactiveDto.InitiatorID, interactiveDto.PassiveID);
        //        if (!isSuccess)
        //        {
        //            return "取消黑名單失敗.";
        //        }
        ...
        //public async Task<string> BreakFriendship(InteractiveDto interactiveDto)
        //{
        //    throw new NotImplementedException();
        //}

        //public async Task<string> BuildFriendship(InteractiveDto interactiveDto)
        //{
        //    try
        //    {
        //        //if (string.IsNullOrEmpty(memberInfo.MemberID) || string.IsNullOrEmpty(friendInfo.MemberID))
        //        //{
        //        //    return "會員編號無效.";
        //        //}

        //        //FriendData friendData = await this.friendRepository.GetFriend(memberInfo.MemberID, friendInfo.MemberID);
        //        //if (friendData == null)
        //        //{
        //        //    return "無好友資料.";
        //        //}
        ...
        //        //friendData.Status = 1;
        //        //friendData.Memo = "好友";
        //        //bool isSuccess = await this.friendRepository.UpdateFriendData(friendData);
        //        //if (!isSuccess)
        //        //{
        //        //    return "建立好友失敗.";
        //        //}
        ...
        //    catch (Exception ex)
        //    {
        //        //this.logger.LogError($"Build Friendship Error >>> MemberData:{Utility.GetPropertiesData(memberInfo)} OtherData:{Utility.GetPropertiesData(friendInfo)}\n{ex}");
        //        return "建立好友發生錯誤.";
        //    }
        //}

        //public Task<Tuple<IEnumerable<MemberInfoDto>, string>> GetFriendList(MemberInfoDto memberInfo)
        //{
        //    throw new NotImplementedException();
        //}
        ...
        ///// <param name="interactiveDto">interactiveDto</param>
        ///// <returns>Tuple(MemberInfoDtos, string)</returns>
        //public async Task<Tuple<IEnumerable<MemberInfoDto>, string>> GetRequestBuildFriendshipList(InteractiveDto interactiveDto)
        //{
        //    try
        //    {
        //        string memberID = interactiveDto.InitiatorID;
        //        if (string.IsNullOrEmpty(memberID))
        //        {
        //            return Tuple.Create<IEnumerable<MemberInfoDto>, string>(null, "會員編號無效.");
        //        }

        //        IEnumerable<FriendData> friendDatas = await this.friendRepository.GetRequestBuildFriendshipList(memberID);
        //        if (friendDatas.Count() == 0)
        //        {
        //            return Tuple.Create<IEnumerable<MemberInfoDto>, string>(null, "無請求好友名單");
        //        }

        //        IEnumerable<MemberData> memberDatas = await this.memberRepository.GetMemebrDataList(friendDatas.Select(x => x.MemberID));
        //        return Tuple.Create(this.mapper.Map<IEnumerable<MemberInfoDto>>(memberDatas), string.Empty);
        //    }
        //    catch (Exception ex)
        //    {
        //        this.logger.LogError($"Get Request Build Friendship List Error >>> MemberID:{interactiveDto.InitiatorID}\n{ex}");
        //        return Tuple.Create<IEnumerable<MemberInfoDto>, string>(null, "取得請求好友名單發生錯誤.");
        //    }
        //}
        ...
        ///// <param name="interactiveDto">interactiveDto</param>
        ///// <returns>string</returns>
        //public async Task<string> RequestBuildFriendship(InteractiveDto interactiveDto)
        //{
        //    try
        //    {
        //        if (string.IsNullOrEmpty(interactiveDto.InitiatorID) || string.IsNullOrEmpty(interactiveDto.PassiveID))
        ...
        //        friendData = this.CreateFriendData(interactiveDto);
        //        bool isSuccess = await this.friendRepository.CreateFriend(friendData);
        //        if (!isSuccess)
        //        {
        //            return "建立好友資料失敗.";
        //        }
        ...
        //    catch (Exception ex)
        //    {
        //        this.logger.LogError($"Request Build Friendship Error >>> InitiatorID:{interactiveDto.InitiatorID} PassiveID:{interactiveDto.PassiveID}\n{ex}");
        //        return "請求好友發生錯誤.";
        //    }
        //}
        ...
        ///// <param name="interactiveDto">interactiveDto</param>
        ///// <returns>Tuple(MemberInfoDto, string)</returns>
        //public async Task<Tuple<MemberInfoDto, string>> SearchFriend(InteractiveDto interactiveDto)
        //{
        //    try
        //    {
        //        if (string.IsNullOrEmpty(interactiveDto.InitiatorID) || string.IsNullOrEmpty(interactiveDto.PassiveID))
        ...
        //        //friendInfo = this.mapper.Map<MemberInfoDto>(await this.memberRepository.GetMemebrData(interactiveDto.InitiatorID));
        //        //if (friendInfo == null)
        //        //{
        ...
        //        //FriendData friendData = await this.friendRepository.GetFriend(memberInfo.MemberID, friendInfo.MemberID);
        //        //friendInfo.Status = friendData == null ? -2 : friendData.Status;
        //        //return Tuple.Create(friendInfo, string.Empty);
        //        return Tuple.Create<MemberInfoDto, string>(null, "搜尋好友發生錯誤.");
        //    }
        //    catch (Exception ex)
        //    {
        //        this.logger.LogError($"Search Friend Error >>> InitiatorID:{interactiveDto.InitiatorID} PassiveID:{interactiveDto.PassiveID}\n{ex}");
        //        return Tuple.Create<MemberInfoDto, string>(null, "搜尋好友發生錯誤.");
        //    }
        //}
